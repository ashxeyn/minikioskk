...
CREATE TABLE `departments` (
  ...
  CONSTRAINT `departments_ibfk_1` FOREIGN KEY (`college_id`) REFERENCES `colleges` (`college_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`program_id`) REFERENCES `programs` (`program_id`),
  CONSTRAINT `users_ibfk_2` FOREIGN KEY (`department_id`) REFERENCES `departments` (`department_id`),
  CONSTRAINT `users_ibfk_3` FOREIGN KEY (`canteen_id`) REFERENCES `canteens` (`canteen_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `orders` (`order_id`, `user_id`, `canteen_id`, `total_amount`, `status`, `payment_status`, `payment_method`, `created_at`, `updated_at`, `completed_at`, `notes`) VALUES
(1, 1, 1, 150.00, 'completed', 'paid', 'cash', '2024-12-12 18:13:17', '2024-12-12 18:13:17', NULL, NULL),
(2, 3, 1, 445.00, 'placed', 'unpaid', 'cash', '2024-12-12 20:28:40', '2024-12-12 20:28:40', NULL, NULL),
(3, 3, 1, 75.00, 'placed', 'unpaid', 'cash', '2024-12-12 20:29:24', '2024-12-12 20:29:24', NULL, NULL),
(4, 3, 1, 80.00, 'placed', 'unpaid', 'cash', '2024-12-12 20:30:07', '2024-12-12 20:30:07', NULL, NULL),
(5, 3, 1, 1500.00, 'placed', 'unpaid', 'cash', '2024-12-12 20:38:36', '2024-12-12 20:38:36', NULL, NULL),
(6, 3, 1, 1725.00, 'placed', 'unpaid', 'cash', '2024-12-12 20:59:25', '2024-12-12 20:59:25', NULL, NULL),
(7, 3, 1, 75.00, 'placed', 'unpaid', 'cash', '2024-12-12 21:01:57', '2024-12-12 21:01:57', NULL, NULL),
(8, 25, 1, 1500.00, 'placed', 'unpaid', 'cash', '2024-12-13 01:25:46', '2024-12-13 01:25:46', NULL, NULL);
...
INSERT INTO `products` (`product_id`, `canteen_id`, `type_id`, `name`, `description`, `price`, `image_url`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'Chicken Adobo', 'Classic Filipino adobo with rice', 75.00, NULL, 'available', '2024-12-12 18:13:17', '2024-12-13 01:25:46'),
(2, 1, 1, 'Sinigang', 'Sour soup with pork and vegetables', 80.00, NULL, 'available', '2024-12-12 18:13:17', '2024-12-12 20:59:25'),
(3, 1, 3, 'Iced Tea', 'Refreshing cold tea', 25.00, NULL, 'available', '2024-12-12 18:13:17', '2024-12-12 20:59:25'),
(4, 2, 2, 'Sandwich', 'Fresh vegetable sandwich', 45.00, NULL, 'available', '2024-12-12 18:13:17', '2024-12-12 20:59:25'),
(5, 10, 1, 'Reo', 'asdas', 2.00, NULL, 'available', '2024-12-13 01:10:24', '2024-12-13 01:10:24'),
(6, 9, 8, 'Reo', 'asdas', 199.00, NULL, 'available', '2024-12-13 01:14:03', '2024-12-13 01:14:03'),
(7, 10, 1, 'Corned Beef Tapa', 'Freshly Made tinapa', 59.00, NULL, 'available', '2024-12-13 01:23:50', '2024-12-13 01:23:50');
