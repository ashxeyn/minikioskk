...
class Order
{
    ...
    function fetchOrders() {
        // Assuming you have a connection to the database using PDO
        $db = new Database();  // Your database connection class
        $conn = $db->connect(); 
        ...
        $sql = "
            SELECT 
                ...
                SUM(oi.quantity) AS total_quantity,  -- Sum of quantities per order
            ...
            WHERE p.canteen_id = o.canteen_id  -- Ensure that products are filtered by the canteen_id
            GROUP BY o.order_id
    ...
    public function fetchOrderById($order_id)
{
    ...
    // Return the order details including canteen_id
    return $order;
}
